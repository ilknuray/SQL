...
select * from calisanlar;--bu tablo icin birlesme yeri isyeri sutunu
select * from markalar;--bu tablo icin birlesme yeri marka_isim sutunu

--SORU1: calisan sayisi 15.000’den cok olan markalarin isimlerini 
--ve bu
