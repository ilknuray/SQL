...
-- SORU1: Tüm filmleri, film türlerini
--ve filimlerde oynayan aktörleri listeleyiniz.
select film_name,category,actor_name from films
as f left join actors as a 
